    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.faqCard}>
          <Text style={styles.question}>How do I save an article?</Text>
          <Text style={styles.answer}>Tap the bookmark icon when reading an article to save it to your collection.</Text>
        </View>

        <View style={styles.faqCard}>
          <Text style={styles.question}>What is "Ask Layman"?</Text>
          <Text style={styles.answer}>It's an AI assistant that can simplify complex news and answer any questions you have about an article.</Text>
        </View>

        <Text style={styles.heading}>Contact Us</Text>
        <Text style={styles.paragraph}>Need more help? Email us at support@laymanapp.com</Text>
      </ScrollView>
    </View>
  );
};
